...
class _BroadcastDemoPageState extends State<BroadcastDemoPage> {
  ...
  void _startPushing() {
    ...
    _timer = Timer.periodic(Duration(seconds: _interval), (timer) {
      ...
      _pushCount++;
      final message = '广播消息 #$_pushCount - ${DateTime.now().toString().substring(11, 19)}';
                            ...
                            children: [
                              ListTile(
                                ...
                                trailing: IconButton(
                                  ...
                                  onPressed: () => _removeSubscriber(subscriber.id),
                                ),
                              ),
                              const Divider(),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text('收到的消息 (${subscriber.messages.length}):'),
                              ),
                              SizedBox(
                                height: 100,
